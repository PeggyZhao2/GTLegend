...
#define ice 10
#define swamp 11
#define fake_treasure 12
#define treasure_pieces 13
#define NPC_3 14
typedef struct {
    /**
...
/**
 * add an NPC at the specific location
 *
 * if there are already items in the map, the previous items are erased
 */
